...
# 배경 이미지 로드
background_image_path = "/Users/bootkorea/Downloads/split_big_pnid/train/images/26071-200-M6-052-00076.png"
...
for i in range(num_images):
    ...
    new_txt_file_path = "/Users/bootkorea/Downloads/split_big_pnid/train/annfiles/26071-200-M6-052-00076.txt"
    ...
    for symbol in all_symbols[start_idx:end_idx]:
        ...
        new_annfile = f"add_domain_randomization_76_{n}_{i}.txt"
    ...
    # 이미지 파일 이름 설정
    new_image_file = f"add_domain_randomization_76_{n}_{i}.png"
